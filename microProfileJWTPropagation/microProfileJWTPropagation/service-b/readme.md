...
This will create an executable jar file **microProfileJWTPropagation-bootable.jar** within the _target_ maven folder. This can be started by executing the following command
    java -jar target/microProfileJWTPropagation-bootable.jar -Djboss.socket.binding.port-offset=100
